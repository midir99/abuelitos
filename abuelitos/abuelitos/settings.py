"""
Django settings for abuelitos project.
...
SECRET_KEY = "django-insecure-dap!0-vmdztuuuhbn%jg49puxvctp3u!)@amvxibj)l_@1%l#n"
...
INSTALLED_APPS = [
    ...
    "civilizations.apps.CivilizationsConfig",
]
